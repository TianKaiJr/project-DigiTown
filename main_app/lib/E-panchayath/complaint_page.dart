...
class _ComplaintListPageState extends State<ComplaintListPage> {
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Details: $details\nStatus: $status', style: TextStyle(color: Colors.black)),
                  isThreeLine: true,
  ...
  final TextEditingController statusController = TextEditingController(text: "Under Review");
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    maxLines: 3,
                    validator: (value) => value!.isEmpty ? 'Please enter the details' : null,
                  ),
                  const SizedBox(height: 10),
                  TextFormField(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            await FirebaseFirestore.instance.collection('Complaint_MGR').add({
