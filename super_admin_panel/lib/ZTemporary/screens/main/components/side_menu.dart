...
import 'package:super_admin_panel/ZTemporary/screens/panchayat/panchayat_screen.dart';
    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          DrawerListTile(
            title: "Panchayat",
            svgSrc: "assets/icons/panchayat_icon.svg",
            press: () => onMenuTap(const PanchayatScreen()),
          ),
          DrawerListTile(
            title: "Hospital",
            svgSrc: "assets/icons/hospital_icon.svg",
